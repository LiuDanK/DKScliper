...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-HN15JSMYET"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-HN15JSMYET');
</script>
...
if (!akina_option('head_focus')) {
    ...
    ?>
        ...
        <script type="text/javascript"><?php echo akina_option('site_statistics'); ?></script><?php }?>
			</header><!-- #masthead -->
			<?php the_headPattern();?>
